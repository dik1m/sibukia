<div class="col-xs-10 col-sm-10 col-md-10 col-lg-10 col-xl-10">
  <div class="card mb-3">
    ...
    <div class="card-body">
      ...
      <form class="form-horizontal" action="<?= site_url('backend/People/update/' . $show['no_ktp']) ?>" enctype="multipart/form-data" method="post">
        ...
        <a href="<?= site_url('backend/People') ?>" title="Kembali"><button class="mb-xs mt-xs mr-xs btn btn-secondary" type="button">Kembali</button></a>
