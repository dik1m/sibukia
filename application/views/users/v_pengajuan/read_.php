			...
			<table width="100%">
				...
				?>
					<tr>
						...
						<td>
							<span class="badge badge-warning" style="color:#FBF9F9"><?php echo 'Pengajuan: ';
																					echo $row['tgl_pengajuan'] ?></span>
							<?php
							if ($row['tgl_ambil'] == '0000-00-00') {
							} else {
							?>
								<span class="badge badge-info"><?php echo 'Pengambilan: ';
																echo $row['tgl_ambil'] ?></span>
							<?php
							}
							?>
							<?php
							...
							?>
								<span class="badge badge-success"><?php echo 'Selesai: ';
																	echo $row['tgl_selesai'] ?></span>
							<?php
							}
							?>
						</td>
						...
						<td>
							...
							?>
								<a href="<?php echo site_url('PengajuanUsr/edit/' . $row['no_ajuan']) ?>" title="Ubah"><span class="badge badge-warning" style="color:#FBF9F9">Ubah</span></a>
							<?php
							} else {
							?>
								<a href="<?php echo site_url('PengajuanUsr/detail/' . $row['no_ajuan']) ?>" title="Detail"><span class="badge badge-info">Detail</span></a>
							<?php
							}
							?>
							...
							?>
								<a href="<?php echo site_url('PengajuanUsr/cetak/' . $row['no_ajuan']) ?>" title="Cetak&bawa pada saat pengambilan berkas" target='_blank'><span class="badge badge-danger">Cetak Undangan</span></a>
							<?php } ?>
