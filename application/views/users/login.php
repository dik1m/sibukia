	...
	<div class="login-box">
		...
		<div class="card card-outline card-primary">
			...
			<div class="card-body">
				...
				<p class="login-box-msg">Halaman Login Buku KIA</p>

				<form action="<?php echo site_url('users/Auth') ?>" method="post">
					<?= form_error('no_kia', '<small class="text-danger">', '</small>'); ?>
					<div class="input-group mb-3">
						<input type="text" name="no_kia" class="form-control" placeholder="Nomor Buku KIA">
						<div class="input-group-append">
							<div class="input-group-text">
								<span class="fas fas fa-book"></span>
							</div>
						</div>
					</div>
					<?= form_error('pswd_kia', '<small class="text-danger">', '</small>'); ?>
					<div class="input-group mb-3">
						<input type="password" name="pswd_kia" class="form-control" placeholder="Password">
						<div class="input-group-append">
							<div class="input-group-text">
