<section class="content">
	<div class="container-fluid">
		<form method="post" action="<?= site_url('backend/CttAnak/create/' . $posy['no_posy'] . '/' . $kia['no_kia']) ?>">
			<div class="row">
						...
						<div class="card-body">
							<table class="table">
								...
								<tr>
									...
									<td>
										<?php
										if ($kia['gender_anak'] == 'Perempuan') {
										?>
											<span class="badge badge" style="background-color:#f829c5;color: white;"><i class="fa fa-venus"></i> <?= $kia['gender_anak'] ?></span>
										<?php } else { ?>
											<span class="badge badge-primary"><i class="fa fa-mars"></i> <?= $kia['gender_anak'] ?></span>
										<?php } ?>
									</td>
								</tr>
							...
							<div class="row">
								<div class="col-md-6">
									...
									<div class="form-row">
										...
										<div class="form-group col-md-6">
											...
											<input type="text" class="form-control" name="bb_ank" placeholder="Masukkan BB(gr)" value="<?= set_value('bb_ank'); ?>">
										</div>
									</div>
									...
									<div class="form-row">
										...
										<div class="form-group col-md-6">
											...
											<input type="text" class="form-control" name="panjang_ank" placeholder="Masukkan BB(gr)" value="<?= set_value('panjang_ank'); ?>">
										</div>
									</div>
									...
									<input type="text" class="form-control" name="vitamin_ank" value="<?= set_value('vitamin_ank'); ?>" placeholder="Masukan Pemberian Vitamin">
									<p></p>
								...
								<div class="col-md-6">
									...
									<select name="hbb_ank" class="form-control">
										<option value="" selected>- Hasil BB -</option>
