	...
	<div class="limiter">
		<div class="container-login100" style="background-image: url('<?php echo base_url(); ?>assets/login/images/bg-01.jpg');">
			<div class="wrap-login100 p-l-55 p-r-55 p-t-65 p-b-54">
				...
				<form class="login100-form validate-form" action="<?php echo site_url('backend/Auth') ?>" method="post">
					...
					<div class="wrap-input100" data-validate="Password is required">
						<span class="label-input100">Password <?= form_error('pswd_user', '<small class="text-danger">', '</small>'); ?></span>
						<input class="input100" type="password" name="pswd_user" placeholder="Masukkan Password">
						<span class="focus-input100" data-symbol="&#xf190;"></span>
					</div>

					<div class="text-right p-t-8 p-b-31">
						<a href="<?php echo site_url('backend/Auth/forgotPassword') ?>">
							Lupa password
						</a>
					</div>
