								...
								<tbody>
									...
									?>
											<tr>
												...
												<td>
													<a href="<?= site_url('backend/CttAnak/edit/' . $k['gb_posykia'] . '/' . $k['no_kia']) ?>" title="Ubah Data" class="badge badge-primary"><i class="far fa-edit"></i></a>
													<a href="<?= site_url('backend/CttAnak/delete/' . $k['gb_posykia']) ?>" title="Hapus data" onclick="javascript: return confirm('Yakin Mau dihapus Nomor KIA <?= $k['no_kia']; ?>')" class="badge badge-danger"><i class="fas fa-trash"></i></a>
													<!-- baru -->
												</td>
											</tr>
