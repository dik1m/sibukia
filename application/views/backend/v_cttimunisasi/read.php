				...
				<tbody>
					...
					?>
						<tr>
							...
							<td>
								<a href="<?php echo site_url('backend/CttImunisasi/detailimu/' . $row['no_posy']) ?>" title="Detail Catatan" class="btn btn-block bg-gradient-warning btn-xs" style="color: white;"><i class="fa fa-paw"></i> Detail</a>
							</td>
						</tr>
					<?php
						$no++;
