    ...
    <div class="limiter">
        <div class="container-login100" style="background-image: url('<?php echo base_url(); ?>assets/login/images/bg-01.jpg');">
            <div class="wrap-login100 p-l-55 p-r-55 p-t-65 p-b-54">
                ...
                <form class="login100-form validate-form" action="<?php echo site_url('backend/Auth/forgotPassword') ?>" method="post">
                    ...
                    <div class="flex-col-c p-t-155">
                        ...
                        <a href="<?php echo site_url('backend/Auth') ?>" class="txt2">
                            login
                        </a>
                    </div>
