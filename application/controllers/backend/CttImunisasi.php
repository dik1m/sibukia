...
class CttImunisasi extends CI_Controller
{
    private $view    = "backend/v_cttimunisasi/";
    private $redirect = "backend/CttImunisasi";
    ...
    public function create()
    {
        ...
        $this->form_validation->set_rules('bb_ank', 'BB', 'required|trim|max_length[3]|numeric');
    ...
    public function detailimu()
    {
        ...
        if ($this->form_validation->run() == false) {
            ...
            $data = array(
                ...
                'sub'  => "Lihat Imunisasi",
                'posy'   => $this->M_CttAnak->create($kd),
                'kia'   => $this->M_CttAnak->detailimu($kd),
            );
            $this->template->load('backend/template', $this->view . 'detailimu', $data);
        }
    }
